...
<div class="nav-bar-containter clear">
      ...
      <header class="clear">
        <div id="menu-btn">
          <label for="nav-bar-toggle" class="toggle-btn"><i class="fa fa-bars"></i> Profile</label>
        </div>
      ...
      <nav id="navigation" class="nav-bar">
        ...
        <a class="hover active" href="profile.php"><i class="fa fa-user-circle-o" aria-hidden="true"></i>Profile</a>
