<html>
  <head>
    <title>Conrad Kennington - Hours</title>
...
<div class="nav-bar-containter clear">
      ...
      <header class="clear">
        <div id="menu-btn">
          <label for="nav-bar-toggle" class="toggle-btn"><i class="fa fa-bars"></i> Menu</label>
        </div>

        <div class="login-btn-area"><a href="#">Login   <i class="fa fa-sign-in" aria-hidden="true"></i></a>
        </div>
      </header>
      ...
      <nav id="navigation" class="nav-bar">
        ...
        <a class="hover active"><i class="fa fa-home" aria-hidden="true"></i>Home</a>
          
        <a href=""><i class="fa fa-sign-in" aria-hidden="true"></i>Login</a>
          
        <a href="#"><i class="fa fa-cog" aria-hidden="true"></i>Settings</a>
          
        <a href="#"><i class="fa fa-tasks" aria-hidden="true"></i>Progress Tracker</a>
          
        <a href="#"><i class="fa fa-user-circle-o" aria-hidden="true"></i>Profile</a>
        
        <a href="#"><i class="fa fa-user-secret" aria-hidden="true"></i>Privacy</a>
      </nav>
</div>
    <div class="content">
