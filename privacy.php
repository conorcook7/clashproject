...
<div class="nav-bar-containter clear">
      ...
      <header class="clear">
        <div id="menu-btn">
          <label for="nav-bar-toggle" class="toggle-btn"><i class="fa fa-bars"></i> Privacy</label>
        </div>
      ...
      <nav id="navigation" class="nav-bar">
        ...
        <a class="hover active" href="privacy.php"><i class="fa fa-user-secret" aria-hidden="true"></i>Privacy</a>
      </nav>
</div>
    <div class="content">
      <h1>This is our Privacy rules!</h1>
          <hr />
      <div class="row"> 	
            <div class="column"><h3>What do you mean privacy?</h3>
              <p>voluptatem sequi nesciunt. Neque porro quisquam est, qui dolorem ipsum quia dolor sit amet, consectetur, adipisci velit, sed quia non numquam eius modi tempora incidunt ut labore et dolore magnam aliquam quaerat voluptatem. Ut enim ad minima veniam, quis nostrum exercitationem ullam corporis suscipit laboriosam, n</p>
            </div>
            <div class="column">
              <h3>Copyright?</h3>
              <p>voluptatem sequi nesciunt. Neque porro quisquam est, qui dolorem ipsum quia dolor sit amet, consectetur, adipisci velit, sed quia non numquam eius modi tempora incidunt ut labore et dolore magnam aliquam quaerat voluptatem. Ut enim ad minima veniam, quis nostrum exercitationem ullam corporis suscipit laboriosam, n</p>
      ...
      <div class="row">
            ...
            <div class="column">
              <h3>Not associated with anyone/thing</h3>
              <p>voluptatem sequi nesciunt. Neque porro quisquam est, qui dolorem ipsum quia dolor sit amet, consectetur, adipisci velit, sed quia non numquam eius modi tempora incidunt ut labore et dolore magnam aliquam quaerat voluptatem. Ut enim ad minima veniam, quis nostrum exercitationem ullam corporis suscipit laboriosam, n</p>
            </div>
        </div>
    </div>
