...
<div class="nav-bar-containter clear">
      ...
      <header class="clear">
        <div id="menu-btn">
          <label for="nav-bar-toggle" class="toggle-btn"><i class="fa fa-bars"></i> Settings</label>
        </div>
      ...
      <nav id="navigation" class="nav-bar">
        ...
        <a class="hover active" href="settings.php"><i class="fa fa-cog" aria-hidden="true"></i>Settings</a>
    ...
    <div class="content">
      <h1>Settings</h1>
          <hr />
      <div class="row"> 	
            <div class="column"><h3>What Settings?</h3>
              <p>Haven't quite gotten this far yet...</p>
            </div>
            <div class="column">
              <h3>Coming soon</h3>
              <p>This page might be changed to something else in the future so stay tuned.</p>
            </div>
    </div>
    <div id="footer">
